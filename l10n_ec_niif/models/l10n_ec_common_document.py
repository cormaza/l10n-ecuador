...
class L10nEcCommonDocument(models.AbstractModel):
    ...
    l10n_ec_base_iva = fields.Float(
        string="Base IVA", compute="_compute_l10n_ec_amounts", store=True
    )
    l10n_ec_base_iva_0 = fields.Float(
        string="Base IVA 0", compute="_compute_l10n_ec_amounts", store=True
    )
    l10n_ec_iva = fields.Float(
        string="IVA", compute="_compute_l10n_ec_amounts", store=True
    )
